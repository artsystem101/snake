...
def main():
    ...
    pygame.display.set_caption('Snake | ArtSystem')
...
def runGame():
    pygame.display.set_caption('Snake | ArtSystem (c)')
...
def drawScore(score):
    if score == "0":
        ...
        pygame.display.set_caption('Snake | ArtSystem (c) ({})'.format(score))
...
def drawName():
    nameSurf = BASICFONT.render('Snake: %s      ' % (config.NAMETAG), True, WHITE)
    nameRect = nameSurf.get_rect()
    nameRect.topright = (WINDOWWIDTH - 120, 10)
